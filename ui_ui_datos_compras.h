...
public:
    ...
    void setupUi(QWidget *ui_datos_compras)
    {
        ...
        ui_datos_compras->resize(452, 411);
        gridLayoutWidget = new QWidget(ui_datos_compras);
        gridLayoutWidget->setObjectName(QString::fromUtf8("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(10, 10, 431, 391));
        ...
        gridLayout->addWidget(lineEdit_7, 4, 1, 1, 2);

        pushButton_3 = new QPushButton(gridLayoutWidget);
        pushButton_3->setObjectName(QString::fromUtf8("pushButton_3"));

        gridLayout->addWidget(pushButton_3, 10, 1, 1, 1);

        pushButton_4 = new QPushButton(gridLayoutWidget);
        pushButton_4->setObjectName(QString::fromUtf8("pushButton_4"));

        gridLayout->addWidget(pushButton_4, 10, 2, 1, 1);

        horizontalSpacer = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout->addItem(horizontalSpacer, 10, 3, 1, 1);
    ...
    void retranslateUi(QWidget *ui_datos_compras)
    {
        ...
        label->setText(QApplication::translate("ui_datos_compras", "COMPRAS", 0, QApplication::UnicodeUTF8));
        ...
        pushButton_3->setText(QApplication::translate("ui_datos_compras", "Guardar", 0, QApplication::UnicodeUTF8));
        pushButton_4->setText(QApplication::translate("ui_datos_compras", "Cancelar", 0, QApplication::UnicodeUTF8));
        label_6->setText(QApplication::translate("ui_datos_compras", "Sub Total", 0, QApplication::UnicodeUTF8));
        label_7->setText(QApplication::translate("ui_datos_compras", "IGV", 0, QApplication::UnicodeUTF8));
