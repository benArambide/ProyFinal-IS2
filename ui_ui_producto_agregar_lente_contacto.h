...
public:
    ...
    void setupUi(QDialog *ui_producto_agregar_lente_contacto)
    {
        ...
        ui_producto_agregar_lente_contacto->resize(663, 577);
        ui_producto_agregar_lente_contacto->setMinimumSize(QSize(663, 577));
        ui_producto_agregar_lente_contacto->setMaximumSize(QSize(663, 577));
        label = new QLabel(ui_producto_agregar_lente_contacto);
        ...
        gridLayout_2->addWidget(lineEdit_8, 5, 1, 1, 1);

        lineEdit_9 = new QLineEdit(gridLayoutWidget);
        lineEdit_9->setObjectName(QString::fromUtf8("lineEdit_9"));

        gridLayout_2->addWidget(lineEdit_9, 4, 1, 1, 1);

        lineEdit_10 = new QLineEdit(gridLayoutWidget);
        lineEdit_10->setObjectName(QString::fromUtf8("lineEdit_10"));

        gridLayout_2->addWidget(lineEdit_10, 3, 1, 1, 1);
        ...
        gridLayout_2->addWidget(lineEdit_12, 1, 1, 1, 1);
        ...
        comboBox->setMinimumSize(QSize(230, 0));
        comboBox->setMaximumSize(QSize(100, 100));

        horizontalLayout_2->addWidget(comboBox);

        pushButton = new QPushButton(gridLayoutWidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setMinimumSize(QSize(38, 27));
        pushButton->setMaximumSize(QSize(38, 27));
        QIcon icon;
        ...
        pushButton_2->setMinimumSize(QSize(38, 27));
        pushButton_2->setMaximumSize(QSize(38, 27));
        ...
        pushButton_3->setMinimumSize(QSize(38, 27));
        pushButton_3->setMaximumSize(QSize(38, 27));
        ...
        pushButton_4->setMinimumSize(QSize(38, 27));
        pushButton_4->setMaximumSize(QSize(38, 27));
        ...
        pushButton_5->setMinimumSize(QSize(38, 27));
        pushButton_5->setMaximumSize(QSize(38, 27));
        ...
        pushButton_6->setMinimumSize(QSize(38, 27));
        pushButton_6->setMaximumSize(QSize(38, 27));
        ...
        pushButton_7->setMinimumSize(QSize(38, 27));
        pushButton_7->setMaximumSize(QSize(38, 27));
        ...
        pushButton_8 = new QPushButton(ui_producto_agregar_lente_contacto);
        pushButton_8->setObjectName(QString::fromUtf8("pushButton_8"));
        pushButton_8->setGeometry(QRect(550, 530, 97, 27));
        pushButton_9 = new QPushButton(ui_producto_agregar_lente_contacto);
        pushButton_9->setObjectName(QString::fromUtf8("pushButton_9"));
        pushButton_9->setGeometry(QRect(410, 530, 97, 27));
    ...
    {
        ui_producto_agregar_lente_contacto->setWindowTitle(QApplication::translate("ui_producto_agregar_lente_contacto", "Dialog", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("ui_producto_agregar_lente_contacto", "Agregar Lente de Contacto", 0, QApplication::UnicodeUTF8));
        ...
        pushButton_8->setText(QApplication::translate("ui_producto_agregar_lente_contacto", "Cancelar", 0, QApplication::UnicodeUTF8));
        pushButton_9->setText(QApplication::translate("ui_producto_agregar_lente_contacto", "Agregar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
