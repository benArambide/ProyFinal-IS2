...
void ui_reporte::configuracion()
{
    ...
    while(query.next())
    {
        ...
        ui->cmb_tienda_mostrador->addItem(query.value(2).toString());
...
void ui_reporte::on_cmb_tienda_mostrador_currentIndexChanged(const QString &arg1)
{
    query.clear();
    query=rep_vend->find_mostrador(arg1);
    ui->cmb_mostrador_m->clear();
    while(query.next())
    {
        ui->cmb_mostrador_m->addItem(query.value(2).toString());
    }
}
...
void ui_reporte::on_view_reporte_vendedor_clicked()
{
    ...
    vector_header header=rep_vend->get_header();
...
void ui_reporte::on_view_reporte_tienda_clicked()
{
    ...
    vector_header header=rep_tienda->get_header();
...
void ui_reporte::on_view_reporte_cliente_clicked()
{
    ...
    vector_header header=rep_cliente->get_header();
