...
# Generated by qmake (2.01a) (Qt 4.7.4) on: jue oct 25 08:53:01 2012
...
SOURCES       = main.cpp \
		...
		rangomedida.cpp moc_mainwindow.cpp \
		moc_sesion.cpp \
		moc_ui_login.cpp \
...
$(TARGET): ui_mainwindow.h ui_ui_login.h ui_ui_cambiarpassdialog.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents mainwindow.h sesion.h conexionbd.h ui_login.h ui_cambiarpassdialog.h usuario.h producto.h marca.h objetopersistente.h calidad.h tamanio.h forma.h color.h tipoluna.h indicerefraccion.h rangomedida.h .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents Icons/Icons.qrc Icons/Icons.qrc .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp sesion.cpp conexionbd.cpp ui_login.cpp ui_cambiarpassdialog.cpp usuario.cpp producto.cpp marca.cpp objetopersistente.cpp calidad.cpp tamanio.cpp forma.cpp color.cpp tipoluna.cpp indicerefraccion.cpp rangomedida.cpp .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents mainwindow.ui ui_login.ui ui_cambiarpassdialog.ui .tmp/OpticalManager1.0.0/ && (cd `dirname .tmp/OpticalManager1.0.0` && $(TAR) OpticalManager1.0.0.tar OpticalManager1.0.0 && $(COMPRESS) OpticalManager1.0.0.tar) && $(MOVE) `dirname .tmp/OpticalManager1.0.0`/OpticalManager1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/OpticalManager1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_sesion.cpp moc_ui_login.cpp moc_ui_cambiarpassdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_sesion.cpp moc_ui_login.cpp moc_ui_cambiarpassdialog.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_ui_login.h ui_ui_cambiarpassdialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_ui_login.h ui_ui_cambiarpassdialog.h
