...
# Generated by qmake (2.01a) (Qt 4.7.4) on: dom nov 25 20:26:44 2012
...
SOURCES       = main.cpp \
		...
		persona.cpp \
		cliente.cpp \
		tipodoc_ident.cpp moc_mainwindow.cpp \
		moc_sesion.cpp \
		moc_ui_login.cpp \
