...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Sep 26 15:12:38 2012
...
SOURCES       = main.cpp \
		...
		sesion.cpp \
		usuario.cpp \
		conexionbd.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		sesion.o \
		usuario.o \
