...
# Generated by qmake (2.01a) (Qt 4.7.4) on: mar oct 2 21:40:47 2012
...
SOURCES       = main.cpp \
		...
		marca_datos.cpp \
		caracteristica_datos.cpp moc_mainwindow.cpp \
		moc_sesion.cpp \
		moc_ui_login.cpp \
