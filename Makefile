...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Sep 29 23:18:18 2012
...
SOURCES       = main.cpp \
		...
		conexionbd.cpp \
		ui_login.cpp \
		ui_cambiarpassdialog.cpp moc_mainwindow.cpp \
		moc_sesion.cpp \
		moc_ui_login.cpp \
