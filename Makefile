...
# Generated by qmake (2.01a) (Qt 4.7.4) on: mié oct 24 05:41:21 2012
...
SOURCES       = main.cpp \
		...
		producto.cpp \
		marca.cpp \
		objetopersistente.cpp moc_mainwindow.cpp \
		moc_sesion.cpp \
		moc_ui_login.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents mainwindow.h sesion.h conexionbd.h ui_login.h ui_cambiarpassdialog.h usuario.h producto.h marca.h objetopersistente.h .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents Icons/Icons.qrc Icons/Icons.qrc .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp sesion.cpp conexionbd.cpp ui_login.cpp ui_cambiarpassdialog.cpp usuario.cpp producto.cpp marca.cpp objetopersistente.cpp .tmp/OpticalManager1.0.0/ && $(COPY_FILE) --parents mainwindow.ui ui_login.ui ui_cambiarpassdialog.ui .tmp/OpticalManager1.0.0/ && (cd `dirname .tmp/OpticalManager1.0.0` && $(TAR) OpticalManager1.0.0.tar OpticalManager1.0.0 && $(COMPRESS) OpticalManager1.0.0.tar) && $(MOVE) `dirname .tmp/OpticalManager1.0.0`/OpticalManager1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/OpticalManager1.0.0
