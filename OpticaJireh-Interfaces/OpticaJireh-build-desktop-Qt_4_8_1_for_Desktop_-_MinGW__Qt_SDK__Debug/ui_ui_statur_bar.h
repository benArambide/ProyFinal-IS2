...
**
** Created: Tue 2. Oct 12:39:20 2012
...
public:
    ...
    void setupUi(QWidget *UI_STATUR_BAR)
    {
        ...
        label_3 = new QLabel(UI_STATUR_BAR);
        label_3->setObjectName(QString::fromUtf8("label_3"));

        gridLayout->addWidget(label_3, 0, 2, 1, 1);

        lineEdit_Buscar = new QLineEdit(UI_STATUR_BAR);
        ...
        pushButton_Buscar = new QPushButton(UI_STATUR_BAR);
        ...
        pushButton_BusquedaAvanzada = new QPushButton(UI_STATUR_BAR);
    ...
    void retranslateUi(QWidget *UI_STATUR_BAR)
    {
        ...
        label_3->setText(QApplication::translate("UI_STATUR_BAR", "Buscar ", 0, QApplication::UnicodeUTF8));
