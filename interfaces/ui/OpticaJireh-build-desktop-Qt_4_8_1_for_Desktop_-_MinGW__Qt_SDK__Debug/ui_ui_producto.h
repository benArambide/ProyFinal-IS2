...
**
** Created: Tue 18. Sep 12:34:58 2012
...
public:
    ...
    QPushButton *pushButton_CotizarProducto;
    ...
    void setupUi(QWidget *UI_PRODUCTO)
    {
        ...
        horizontalSpacer = new QSpacerItem(168, 10, QSizePolicy::Fixed, QSizePolicy::Minimum);
        ...
        pushButton_DeshabilitarProducto->setIcon(icon);
        pushButton_DeshabilitarProducto->setIconSize(QSize(32, 32));

        gridLayout->addWidget(pushButton_DeshabilitarProducto, 5, 0, 1, 1);

        pushButton_CotizarProducto = new QPushButton(UI_PRODUCTO);
        pushButton_CotizarProducto->setObjectName(QString::fromUtf8("pushButton_CotizarProducto"));
        pushButton_CotizarProducto->setIcon(icon);
        pushButton_CotizarProducto->setIconSize(QSize(32, 32));

        gridLayout->addWidget(pushButton_CotizarProducto, 6, 0, 1, 1);
        ...
        pushButton_NuevoProducto->setIcon(icon);
        ...
        label->raise();
        pushButton_NuevoProducto->raise();
        lineEdit->raise();
        label_2->raise();
        tableWidget->raise();
        tableWidget_2->raise();
    ...
    void retranslateUi(QWidget *UI_PRODUCTO)
    {
        ...
        pushButton_ModificarProducto->setText(QApplication::translate("UI_PRODUCTO", "Modificar Producto", 0, QApplication::UnicodeUTF8));
        pushButton_ModificarProducto->setShortcut(QApplication::translate("UI_PRODUCTO", "Ctrl+M", 0, QApplication::UnicodeUTF8));
        pushButton_DeshabilitarProducto->setText(QApplication::translate("UI_PRODUCTO", "Deshabilitar Producto", 0, QApplication::UnicodeUTF8));
        pushButton_DeshabilitarProducto->setShortcut(QApplication::translate("UI_PRODUCTO", "Ctrl+D", 0, QApplication::UnicodeUTF8));
        pushButton_CotizarProducto->setText(QApplication::translate("UI_PRODUCTO", "Cotizar Producto", 0, QApplication::UnicodeUTF8));
        pushButton_CotizarProducto->setShortcut(QApplication::translate("UI_PRODUCTO", "Ctrl+C", 0, QApplication::UnicodeUTF8));
        pushButton_NuevoProducto->setText(QApplication::translate("UI_PRODUCTO", "Nuevo Producto", 0, QApplication::UnicodeUTF8));
